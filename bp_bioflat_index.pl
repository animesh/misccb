#!perl -w
#$Id: bioflat_index.PLS,v 1.4 2005/04/26 15:10:54 jason Exp $

=head1 NAME

bioflat_index.PLS - index sequence files using Bio::DB::Flat
...
=head1 USAGE
 ...
 bioflat_index.PLS <options> file1 file2 file3...
