#!/usr/bin/perl -w
# $rcs = ' $Id: setup.pl,v 1.17 2001/03/03 19:49:33 daniel Exp $ ' ;	
...
# Also note that setup.pl does not get installed, as it's only needed once
install_file("indexer_web.pl", $instdir."indexer_web.pl", "0755");
install_file("indexer_filesystem.pl", $instdir."indexer_filesystem.pl", "0755");
install_file("SGMLEntities.pl", $instdir."SGMLEntities.pl", "0755");
install_file("conf.pl", $instdir."conf.pl", "0755");
install_dir($instdir."data", "0755");
install_dir($instdir."temp", "0755");
install_dir($instdir."conf", "0755");
install_file("conf/stopwords.txt", $instdir."conf/stopwords.txt", "0755", "keep");
install_dir($instdir."templates", "0755");
install_file("templates/search.html", $instdir."templates/search.html", "0755", "keep");
install_file("templates/search_de.html", $instdir."templates/search_de.html", "0755", "keep");
install_file("templates/no_match.html", $instdir."templates/no_match.html", "0755", "keep");
install_file("templates/no_match_de.html", $instdir."templates/no_match_de.html", "0755", "keep");
...
my $other_filetypes = input("Any other filetypes? (enter a comma-separated list)", "", []);
...
may notify them by email when upgrades become available. I can send
...
print "
To find out how to index your site and integrate Perlfect Search with 
your pages, please refer to the FAQ which can be found at
...
if( ! eval("require DB_File") ) 
  {
    print "*** WARNING: The DB_File module was not found on your system.\n";
    print "*** Perlfect Search *might* run without, but it is strongly\n";
    print "*** recommended to install DB_File. Please check the FAQ at\n";
