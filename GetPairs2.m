function pairs = GetPairsSpanningUnmappedRef2(ContigRef, OverlapRef, NameHashRef, RefFasta, clipping_thrs, MinGapSize, MaxGapSize, AllowReverse) 
%
%
% Thsi function is depricated
%
% INPUT
