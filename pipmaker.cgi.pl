...
# $Id: pipmaker.cgi.pl,v 1.66 2003/03/01 00:21:43 schwartz Exp $
...
sub check_queue_size {
  ...
  err $q, "Too many submissions in the work queue.\n"
    if nsubdirs("$tmp/work") > 50;
}
