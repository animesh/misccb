...
fastx34_t -m 9 -S -q mgtt2_x.seq q 1 > test_t2.xk1_t
...
tfastx34_t -m 9 -q -i -3 -m 6 mgstm1.aa %p > test_m1.tx2_t.html
...
fasta34 -m 9 -q mgstm1.seq %RMB 4 > test_m1.ok4 
echo "done"
...
tfasty34 -m 9 -q mgstm1.aa %RMB > test_m1.ty2 
echo "done" `date`
