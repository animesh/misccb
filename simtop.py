# coding: utf-8
"""
An modified implementation of IF network is based on the CUBA and COBA models of Vogels & Abbott (J. Neurosci, 2005).  The model consists of a network of excitatory and ihibitory neurons, connected via current-based "exponential" ynapses (instantaneous rise, exponential decay).
Andrew Davison, UNIC, CNRS
From $Id:VAbenchmarks.py 5 2007-04-16 15:01:24Z davison $
"""
