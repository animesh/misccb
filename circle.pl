#!/usr/bin/perl -wI/home/users/sac/sac2/devo/perl/objects
use strict;
...
print "\nAttempting to change our circle's data via accessor:\n\n";
...
print "\nAttempting to change our circle's data directly:\n\n";
$circleObj->{'color'} = 'puce';
$circleObj->printStats();
