...
print "QueryName\tQueryLength\tHitName\tHitLength [MatchLength of TotalHitlength]\tSignificance\tIdentity\tStrand H / Q\tMatchRegion [Start - End of Query with Hit Start - End] \n";
...
#	 print "HSP\tstrand\t" .         $hsp->strand('list') . "\t";
	 print $hsp->strand('hit') . " / ";
	 print $hsp->strand('query') . "\t";
	 print $hsp->start('query') . " - ";
	 print $hsp->end('query') . " region of query with ";
	 print $hsp->start('hit') . " - ";
	 print $hsp->end('hit') . " of hit\, ";
#	 print "HSP\talignment\n";
